...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public native String setExpcalretToTextView(String expression);

    @Override
    public void onClick(View v) {
        Log.e("TAF", "www.theappsfirm.com");
        ...
        switch (btnID) {
            ...
            case R.id.buttonCal: {
                ...
                TextView tv = findViewById(R.id.sample_text);
                String result = setExpcalretToTextView(expressionInputBox.getText().toString());
                tv.setText(result);
                break;
            }
            case R.id.buttonAdd: {
