...
class Exercise1Fragment : BaseFragment() {
    ...
    private suspend fun getReputationForUser(userId: String) : Int = withContext(Dispatchers.Default){
        logThreadInfo("getReputationForUser()")
        return@withContext getReputationEndpoint.getReputation(userId)
    }
